...
path, exact filename, exact filename stem, title/identifier phrase, dense lexical coverage, all
significant terms, then partial match. For queries of three through eight significant terms,
