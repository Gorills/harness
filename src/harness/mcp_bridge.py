...
_SERVER_INSTRUCTIONS = (
    ...
    "or the path is known. Use project_search before broad native work for explicit identifiers or "
    "quoted literals and for Knowledge/Task retrieval; natural-language code/doc discovery may use "
    "native search directly. Ordinary lexical code/doc hits do not block broader native fallback. "
    "A known exact path may skip search, not Task. Complete untruncated exact_coverage replaces "
    "native rg/grep for that needle. "
