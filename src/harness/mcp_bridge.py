...
_SERVER_INSTRUCTIONS = (
    ...
    "only allowed pre-status action. Russian Task title/summary/next_step and Knowledge title/body; "
    ...
    "or the path is known. Identifiers/literals or Knowledge/Tasks: project_search before broad "
    "native work. Natural-language code/doc discovery may use native "
