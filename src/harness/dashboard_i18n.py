...
SKILL_SCOPE_DATABASE = "Базы данных"
SKILL_SCOPE_GODOT = "Godot"
SKILL_SCOPE_CONTAINERS = "Контейнеры"
SKILL_SCOPE_OBSERVABILITY = "Observability"
SKILL_SCOPE_CI = "CI / Release"
SKILL_SCOPE_DEPLOYMENT = "Deployment"
