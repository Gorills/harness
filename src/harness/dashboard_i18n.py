...
EMPTY_WORKSPACES_TITLE = "Нет рабочих копий"
EMPTY_WORKSPACES_HINT = "Выполните harness scan в Git-репозитории."
EMPTY_PROJECT_WORKSPACES_TITLE = "Нет рабочих копий"
EMPTY_PROJECT_WORKSPACES_HINT = "У проекта нет зарегистрированных копий."
...
SEARCH = "Найти"
NO_SEARCH_HITS_TITLE = "Ничего не найдено"
RECENT_TASKS = "Задачи"
NO_TASKS_TITLE = "Нет задач"
REVISION = "рев."
TASK_FACTS = "Данные"
WORKSPACE = "Копия"
STATE = "Статус"
